...
# Allow development access from any interface (dev only)
if DEBUG:
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.shell_navigation',
            ],
        },
    },
]
...
# Use PostgreSQL if DB_ENGINE env var is set, otherwise SQLite (dev default)
...
if DB_ENGINE == 'django.db.backends.postgresql':
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'jiren_db'),
...
# HTTPS & Secure Headers (Enable in Production)
if not DEBUG:
    ...
    # Development mode — cookies work over HTTP
